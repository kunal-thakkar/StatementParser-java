...
public class FetchingEmail {
   ...
   public static void main(String[] args) {
      ...
      String host = "52.66.72.94";// change accordingly
      String mailStoreType = "pop3";
      String username = "admin@krishnaconsultancy.co.in";// change accordingly
      String password = "admin@krishnaconsultancy";// change accordingly
   ...
   */
   public static void writePart(Part p) throws Exception {
      ...
      if(Part.ATTACHMENT.equalsIgnoreCase(p.getDisposition())){
    	  ...
    	  mimeBodyPart.saveFile(mimeBodyPart.getFileName());
      }
      System.out.println("----------------------------");
